...
const Hero = () => {
    return (
        <div className="flex flex-col justify-between items-center w-full h-full">
            <div className="flex flex-col gap-5 w-1/2 order-2">
                ...
                <p className="flex flex-wrap w-[500px] text-purple-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus exercitationem soluta reprehenderit sequi beatae. Deleniti, a! Similique obcaecati beatae laborum saepe, consequuntur eum.</p>
